...
Status: **Not started; 文档准备完成，等待具体授权**. See the
[P3.5b constrained CRUD validation task document](./P3.5b-constrained-crud-validation.md).
No real DNS create, update, or delete has been executed; specific mutation
authorization, test-only/disposable or reversible-zone approval, DNS Write
proof, naming, and cleanup approval remain prerequisites.
...
Status: **Not started / blocked by remaining evidence**. P3.5b has not started,
P3.5c remains incomplete, and P4.2 remains Partial with Gallery preflight
