@{
    ...
    FunctionsToExport = @()
    CmdletsToExport = @('Get-CfZone', 'Get-CfDnsRecord', 'New-CfDnsRecord', 'Remove-CfDnsRecord', 'Set-CfDnsRecord', 'Get-CfD1Database', 'New-CfD1Database', 'Remove-CfD1Database', 'Set-CfD1Database')
    VariablesToExport = @()
    AliasesToExport = @()
}
